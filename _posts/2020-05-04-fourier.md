...
Pour son analyse de la trasnformée de Fourier on s'intéresse donc à deux courbes qu'on appelle *spectre d'amplitude* et *spectre de phase* qui représentent respectivement le module de notre fonction et sa phase, en fonction de la pulsation $\omega$ ou de la fréquence $f=\frac{2\pi}{\omega}$. 
