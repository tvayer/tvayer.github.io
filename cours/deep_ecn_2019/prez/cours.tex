...
\title[GAN's]{Going further with Deep Learning} % The short title appears at the bottom of every slide, the full title is only on the title page
...
Maybe the first architecture for images (60k parameters) \cite{LeCun1989} 
...
\begin{frame}
\frametitle{How to use the models for your own application ?}
